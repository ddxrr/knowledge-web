<template>
    <div class="homeView">
        ...
        <div class="titleArea">
            ...
            <div class="search">
                <div class="inputTypeB">
                    ...
                    >
                        <template #suffix>
                            <div class="searchSet" v-show="state.retrieveShow" @click="retrieveSearch">
        ...
        <div class="mainContent" @click="handleClick" @mousedown="handleMouseDown" @mousemove="handleMouseMove">
            <RetrieveContent
                v-if="state.retrieveShow"
                ref="retrieveRef"
                :searchContent="state.content"
                :currentType="state.currentType"
                @showDetailPage="showDetailPage"
                @clearSelectedTypeAndContent="clearSelectedTypeAndContent"
            />
        </div>
...
onMounted(()=>{
    ...
    state.currentType = queryParam.type?Number(queryParam.type):''
    state.content = queryParam.content?queryParam.content:''
    state.currentMoreIndex = queryParam.currentMoreIndex?queryParam.currentMoreIndex:''
    retrieveSearchOper()
})
//根据index去的当前type值
